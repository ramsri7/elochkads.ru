...
<p style="padding-top:10px;"><textarea name="comment" id="comment" cols="48" rows="10" tabindex="4"></textarea></p>

<p style="padding-top:10px;"><input name="submit" type="submit" id="submit" tabindex="5" value="Submit Comment" />
