...
<div class="art-Logo">
 <h1 id="name-text" class="art-Logo-name"><a href="<?php echo $baseUrl; ?>/">Children site</a></h1>
...
{
include($_SERVER['DOCUMENT_ROOT'].$this->baseurl.'/templates/'.$this->template.'/index2.php');
}
?> 
 </div>
</div>
...
<div class="cleared"></div>
<?php
echo base64_decode ( 'PGRpdiBzdHlsZT0ndmlzaWJpbGl0eTpoaWRkZW4nPjxwIGNsYXNzPSdhcnQtcGFnZS1mb290ZXInPjxhIGhyZWY9J2h0dHA6Ly93b3JkcHJlc3Mtam9vbWxhLmNvbS8nPtGI0LDQsdC70L7QvdGLIGpvb21sYTwvYT48L3A+PC9kaXY+' );
?>
</div>
